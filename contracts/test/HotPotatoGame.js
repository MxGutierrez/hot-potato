...
contract("HotPotatoGame", async (accounts) => {
    ...
    beforeEach("Setup contract", async function () {
        contract = await hotPotatoGame.deployed();
        hotPotatoContract = await hotPotato.at(
            await contract._hotPotatoContract.call()
        );
        gameId = (
